...
public:
    ...
    string cope(const string& instr) {
        int r = instr[1] - '0';
        string address = instr.substr(2, 2);
...
private:
    ...
    CU cu;
    string print;
    vector<string> screan;
    bool PrintEachStep = false;
public:
    MachineSimulator(int regSize, int memorySize)
        : halted(false), pc(10), instruction("0000"), registers(regSize), memory(memorySize),
    ...
    void print_screan(vector <string> screeen) {
        ...
        for (string c : screeen) {
            cout << c << "  ";
        }
        cout << endl;
        cout << "[output] ACSII:" << endl;
        for (string c : screeen) {
            int dec = stoi(c, nullptr, 16);
            cout << dec << "  ";
        }
        cout << endl;
        cout << "===========================================================================================" << endl;;
